...
export default function  Chart() {
  ...
  if (!isMounted) {
    ...
    jobsData && jobsData.data.forEach((app: any) => {
        ...
        if (active && payload && payload.length) {
          return (
            <div className="px-5 py-3 text-white bg-black rounded-lg custom-tooltip">
              ...
              <p className="text-sm text-center desc">{`${payload[0].value}`} Job(s) posted</p>
            </div>
          );
        }
        return null;
        ...
        <div className='mt-5'>
            <AreaChart
                    ...
                    >
                      ...
                      <Area type="bump" dataKey="uv" stroke="#8884d8" fill='#002031'  strokeWidth={3}  />

...
export default function Testimonial({ target }: any) {
  ...
  return (
    <div className="px-banner-clamp py-5 space-y-5 sm:space-y-10 ">
            <motion.h1
               initial={{ opacity: 0, y: 30 }}
               whileInView={{ opacity: 1, y: 0 }}
               transition={{ duration: 0.4 }}
              className="sm:text-4xl text-xl font-bold text-center w-[30%] flex mx-auto">{target.test_header}</motion.h1>

        <div className="flex sm:flex-row flex-col max-sm:gap-3 justify-between">
            {
